...
bool PrepareShaderPrograms()
{
	...
	FOR(i, NUMSHADERS)
	{
		...
		shShaders[i].LoadCShader("Shaders\\"+sShaderFileNames[i], iShaderType);
	}
...
bool CShader::LoadCShader(string sFile, int a_iType)
{
	...
	if(iCompilationStatus == GL_FALSE)
	{
		...
		sprintf(sFinalMessage, "Error! Shader file %s wasn't compiled!tits The compiler returned:\n\n%s", sFile.c_str(), sInfoLog);
