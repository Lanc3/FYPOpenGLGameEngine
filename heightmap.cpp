...
{
	bool bOK = true;
	bOK &= shShaders[0].LoadCShader("Shaders\\terrain.vert", GL_VERTEX_SHADER);
	bOK &= shShaders[1].LoadCShader("Shaders\\terrain.frag", GL_FRAGMENT_SHADER);
	bOK &= shShaders[2].LoadCShader("Shaders\\dirLight.frag", GL_FRAGMENT_SHADER);
